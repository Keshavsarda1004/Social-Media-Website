    ...
    return (
        <div className='min-h-screen relative bg-slate-50'>
            <div className='max-w-6xl mx-auto p-6'>
                {/* Title */}
                <div className='mb-8'>
                    <h1 className='mb-2 font-bold text-3xl text-slate-900'>Messages</h1>
                ...
                <div className='flex flex-col gap-3'>
                    {
                        dummyConnectionsData.map((user) => (
                            <div key={user._id} className='flex flex-warp gap-5 p-6 bg-white shadow rounded-md max-w-xl'>
