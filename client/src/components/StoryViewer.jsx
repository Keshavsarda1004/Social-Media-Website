...
const StoryViewer = ({viewStory, setViewStory}) => {
    ...
    return (
        <div className='fixed inset-0 h-screen bg-black bg-opacity-90 z-110 flex items-center justify-center' style={{backgroundColor: viewStory.media_type === 'text' ? viewStory.background_color : "#000000"}}>
            ...
            {/* User Info - Top Left */}
            <div className='absolute top-4 left-4 flex items-center space-x-3 p-2 px-4 sm:p-4 sm:px-8 rounded backdrop-blur-2xl bg-black/50'>
            ...
            {/* Close Button */}
            <button onClick={handleClose} className='absolute top-4 right-4 text-3xl text-white font-bold focus:outline-none'>
